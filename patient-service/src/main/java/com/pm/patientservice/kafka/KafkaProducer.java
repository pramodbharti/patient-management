...
public class KafkaProducer {
    ...
    public void sendBillingAccountEvent(String patientId, String patientName, String patientEmail) {
        ...
        try {
            ...
            log.error("Error sending BillingAccountCreated event: {}", billingAccountEvent);
        }
    }
}
